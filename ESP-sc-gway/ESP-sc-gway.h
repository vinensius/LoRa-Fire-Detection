...
#define _DESCRIPTION "Gateway Wildfire IoT"
#define _EMAIL "c11180034@john.petra.ac.id"
...
// ntp
#define NTP_TIMESERVER "id.pool.ntp.org"  // Country and region specific
#define NTP_TIMEZONES 7         // How far is our Timezone from UTC (excl daylight saving/summer time)
